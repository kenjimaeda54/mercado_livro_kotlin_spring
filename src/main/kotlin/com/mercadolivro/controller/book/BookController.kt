...
class BookController(
    ...
    @GetMapping
    fun findAllBook(): List<BookResponse> = bookService.findAllBook().map { it.toResponse() }

    @GetMapping("/actives")
    fun findBookActives(): List<BookResponse> = bookService.findActives().map { it.toResponse() }
